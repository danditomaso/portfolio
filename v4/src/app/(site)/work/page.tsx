        ...
        <Link href={`/work/${w.slug}`} className="flex flex-col">
          ...
          {w.tech.length > 0 && (
            <div className="flex gap-2">
              ...
              <Text variant="p" className="font-light uppercase">
...
export default async function WorkListPage() {
  ...
  return (
    <section className="flex h-full gap-16 w-full">
      <div className="flex w-1/3 flex-col gap-8 place-content-center px-16">
      ...
      <div className="flex flex-col w-1/2 mt-[10%] pl-[2%] ">
